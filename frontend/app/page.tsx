    ...
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
      <div className="max-w-2xl w-full text-center">
        ...
        <p className="text-lg text-gray-600 mb-12">
          Connecting people in crisis to the nearest NGO with available
          resources — instantly.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl border border-gray-200 p-8">
            ...
            <p className="text-gray-500 text-sm mb-6">
              Submit a help request and we will match you with the nearest NGO
              that has resources available.
            </p>
            <Link
              href="/request"
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8">
            ...
            <p className="text-gray-500 text-sm mb-6">
              Access your dashboard to manage resources, view incoming requests,
              and dispatch aid.
            </p>
            <Link
              href="/login"
